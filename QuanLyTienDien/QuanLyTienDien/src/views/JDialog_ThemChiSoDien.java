...
public class JDialog_ThemChiSoDien extends javax.swing.JDialog {
     ...
     */
    private final ChiSoDienQltdImpl chiSoDienHuyImpI = new ChiSoDienQltdImpl();
    private final ThangQltdImpl thangHuyImpl = new ThangQltdImpl();
    ...
    private void initData(){
        Thang lastThangOf = thangHuyImpl.getLastThangOf(khachHang.getMaKH());
        Thang lastThang = thangHuyImpl.getLastThang();
        ...
        if (lastThangOf != null){
            ...
            if (lastThangOf.getThangID() == lastThang.getThangID()){
                ...
                thang = thangHuyImpl.getThang(lastThangOf.getThangID() + 1);
    ...
    private void initView(){
        ...
        ChiSoDien chiSoDienLast = chiSoDienHuyImpI.getLastChiSoDien(khachHang.getMaKH());
    ...
    private void addChiSoDien(){
        ...
        if (chiSoDienHuyImpI.createORUpdate(chiSoDienInsert) != 0){
    ...
    private boolean validChiSo(String chiSoCu_text, String chiSoMoi_text){
        try{
            ...
            if (thang != null){
                ChiSoDien chiSoDienSau = chiSoDienHuyImpI.getChiSoDien(khachHang.getMaKH(), thang.getThangID());
    ...
    private void initComponents() {
        ...
        jTextField_MaKH.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jTextField_MaKHActionPerformed(evt);
            }
        });
        ...
        jTextField_ChiSoMoi.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jTextField_ChiSoMoiActionPerformed(evt);
            }
        });
        ...
        jTextField_Thang.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jTextField_ThangActionPerformed(evt);
            }
        });
    ...
    private void jTextField_ChiSoMoiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTextField_ChiSoMoiActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jTextField_ChiSoMoiActionPerformed

    private void jTextField_ThangActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTextField_ThangActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jTextField_ThangActionPerformed

    private void jTextField_MaKHActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTextField_MaKHActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jTextField_MaKHActionPerformed
