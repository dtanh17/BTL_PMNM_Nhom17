...
public class ChiSoDien {
    ...
    public ChiSoDien(long id, int maKH, int thangID, int chiSoCu, int chiSoMoi, Date ngayGhi) {
        this.id = id;
        this.maKH = maKH;
    ...
    public String toString() {
        return "ChiSoDien{" + "id=" + id + ", maKH=" + maKH + ", thangID=" + thangID + ", chiSoCu=" + chiSoCu + ", chiSoMoi=" + chiSoMoi + ", ngayGhi=" + ngayGhi + '}';
    }
